...
KANGING_STR = [
    ...
    "Aku kang y kakak :)",
    "Lagi baca mantra buat ambil nih sticker...",
    "Plagiarising hehe...",
...
async def kang(args):
    ...
    if photo:
        ...
        await args.edit(f"`Curry successfully!`\
            \n[Klik sini](t.me/addstickers/{packname}) buat liat stikernya",
                        parse_mode='md')
