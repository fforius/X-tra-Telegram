...
@register(outgoing=True, pattern="^\.apdet(?: |$)(.*)")
async def upstream(ups):
    ...
    if conf != "now" and not force_update:
        ...
        await ups.respond('`do \".apdet now\" to update`')
        return
    ...
    if force_update:
        ...
        await ups.edit('`Updating Poco Bot, please wait....`')
    ...
    if HEROKU_API_KEY is not None:
        ...
        if BOTLOG:
            await ups.client.send_message(
                ...
                "Your Poco Bot was successfully updated")
